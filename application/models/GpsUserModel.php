...
// END MODULO DE ROLES 
	...
	public function refreshPersonal($post,$table){
        try {
            $db = Zend_Db_Table::getDefaultAdapter();
            $qry = $db->query("UPDATE $table SET nombre = ?, apellido_pa = ?, apellido_ma = ?, curp = ?, puesto = ?, status_expediente=?, nss = ?, rfc = ?, telefono = ?, email_personal = ?, dia_pago = ?, hora_pago =?, disponibilidad = ? WHERE id = ?",array(
               	$post['name'],
            	$post['apellido_pa'],
            	$post['ampellido_ma'],
            	$post['curp'],
    ...
    public function Informaciongeneral($id){
        try{
            ...
            $qry = $db->query("SELECT pc.id, pc.nombre, pc. apellido_pa, pc.apellido_ma, pc.imagen, pc.curp, pc.puesto,
                                    pc.status_expediente, pc.telefono, pc.email_personal, pc.nss, pc.rfc, pc.dia_pago, pc.hora_pago, pc.status_personal, pc.fecha_personal, pc.status_cuadrilla, pc.tipo_proyectopersonal, pc.sitio_tipoproyectopersonal, pc. id_sitiopersonal, pc.name_sitio,pc.delete_status ,pp.id as idpuesto, pp.nombre as name_puesto from personal_campo pc LEFT JOIN puestos_personal pp on pc.puesto = pp.id Where pc.id = ?",array($id));
            $row = $qry->fetchAll();
            return $row;
            $db->closeConnection();
        }catch (Exception $e){
    ...
    public function Getcountpersonaldirectorio($table,$offset,$no_of_records_per_page){
        try{
            $db = Zend_Db_Table::getDefaultAdapter();
            $qry = $db->query("SELECT pc.id, pc.nombre, pc. apellido_pa, pc.apellido_ma, pc.imagen, pc.curp, pc.puesto,
                                    pc.status_expediente, pc.telefono, pc.email_personal, pc.nss, pc.rfc, pc.dia_pago, pc.hora_pago, pc.status_personal, pc.fecha_personal, pc.status_cuadrilla, pc.tipo_proyectopersonal, pc.sitio_tipoproyectopersonal, pc. id_sitiopersonal, pc.name_sitio,pc.delete_status ,pp.id as idpuesto, pp.nombre as name_puesto from personal_campo pc LEFT JOIN puestos_personal pp on pc.puesto = pp.id Where pc.delete_status =0 order by pc.apellido_pa asc LIMIT $offset,$no_of_records_per_page");
            $row = $qry->fetchAll();
            return $row;
            $db->closeConnection();
        }catch (Exception $e){
    ...
    public function nombrepersonalcount($nombre,$offset,$no_of_records_per_page){  
        try{
            $db = Zend_Db_Table::getDefaultAdapter();
            $qry = $db->query("SELECT pc.id, pc.nombre, pc. apellido_pa, pc.apellido_ma, pc.imagen, pc.curp, pc.puesto,
                                    pc.status_expediente, pc.telefono, pc.email_personal, pc.nss, pc.rfc, pc.dia_pago, pc.hora_pago, pc.status_personal, pc.fecha_personal, pc.status_cuadrilla, pc.tipo_proyectopersonal, pc.sitio_tipoproyectopersonal, pc. id_sitiopersonal, pc.name_sitio,pc.delete_status ,pp.id as idpuesto, pp.nombre as name_puesto from personal_campo pc LEFT JOIN puestos_personal pp on pc.puesto = pp.id Where pc.delete_status= 0 AND pc.nombre like '%{$nombre}%'  LIMIT $offset,$no_of_records_per_page");
            $row = $qry->fetchAll();
            return $row;
            $db->closeConnection();
        }catch (Exception $e){
    ...
    public function nombresitiosexcel(){  
        try{
            $db = Zend_Db_Table::getDefaultAdapter();
            $qry = $db->query("SELECT s.id, s.Idgps, s.id_cliente, s.nombre, s.cliente, s.cliente, s.direccion, s.ciudad, s.estado, s.region, s.estructura, s.altura, s.edificio, s.tipo_sitio, s.latitude, s.longitude 
                from sitios s");
            $row = $qry->fetchAll();
            return $row;
            $db->closeConnection();
    ...
    public function puestopersonalcount($puesto,$offset,$no_of_records_per_page){  
        try{
            $db = Zend_Db_Table::getDefaultAdapter();
            $qry = $db->query("SELECT pc.id, pc.nombre, pc. apellido_pa, pc.apellido_ma, pc.imagen, pc.curp, pc.puesto,
                                    pc.status_expediente, pc.telefono, pc.email_personal, pc.nss, pc.rfc, pc.dia_pago, pc.hora_pago, pc.status_personal, pc.fecha_personal, pc.status_cuadrilla, pc.tipo_proyectopersonal, pc.sitio_tipoproyectopersonal, pc. id_sitiopersonal, pc.name_sitio,pc.delete_status ,pp.id as idpuesto, pp.nombre as name_puesto from personal_campo pc LEFT JOIN puestos_personal pp on pc.puesto = pp.id Where pp.nombre  like '%{$puesto}%' LIMIT $offset,$no_of_records_per_page");
            $row = $qry->fetchAll();
            return $row;
            $db->closeConnection();
        }catch (Exception $e){
    ...
    public function statuspersonalcount($status,$offset,$no_of_records_per_page){
        try{
            $db = Zend_Db_Table::getDefaultAdapter();
             $qry = $db->query("SELECT pc.id, pc.nombre, pc. apellido_pa, pc.apellido_ma, pc.imagen, pc.curp, pc.puesto,
                                    pc.status_expediente, pc.telefono, pc.email_personal, pc.nss, pc.rfc, pc.dia_pago, pc.hora_pago, pc.status_personal, pc.fecha_personal, pc.status_cuadrilla, pc.tipo_proyectopersonal, pc.sitio_tipoproyectopersonal, pc. id_sitiopersonal, pc.name_sitio,pc.delete_status ,pp.id as idpuesto, pp.nombre as name_puesto from personal_campo pc LEFT JOIN puestos_personal pp on pc.puesto = pp.id Where pc.status_expediente = ?   LIMIT $offset,$no_of_records_per_page",array($status));
            $row = $qry->fetchAll();
            return $row;
            $db->closeConnection();
        }catch (Exception $e){
